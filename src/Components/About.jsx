...
const AnimatedContainer = ({ children }) => {
  ...
  return (
    <div
      ref={ref}
      className={`fade-in w-full md:w-3/4 bg-white bg-opacity-30 backdrop-filter backdrop-blur-md container mx-auto px-2 md:px-4 flex flex-col md:flex-row items-center justify-center rounded-md ${inView ? 'visible' : ''}`}
    >
      {children}
    </div>
  );
...
const About = () => {
  return (
    <div id="About">
      <div className="container mx-auto mt-6 text-black grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-8">
        <AnimatedContainer>
          <div>
            <h2 className="text-2xl md:text-3xl font-extrabold">About Us</h2>
            <p className="text-base md:text-lg text-gray-700 mb-4 mt-4 leading-relaxed">
        ...
        <AnimatedContainer>
          <div>
            <h2 className="text-2xl md:text-3xl font-extrabold mt-2">Our Commitment to Quality</h2>
            <p className="text-base md:text-lg text-gray-700 mb-4 mt-4 leading-relaxed">
        ...
        <AnimatedContainer>
          <div>
            <h2 className="text-2xl md:text-3xl font-extrabold mb-2 mt-3">Unparalleled Selection</h2>
            <p className="text-base md:text-lg text-gray-700 mb-4 mt-3 leading-relaxed">
        ...
        <AnimatedContainer>
          <div>
            <h2 className="text-2xl md:text-3xl font-extrabold mb-2 mt-3">Expert Guidance</h2>
            <p className="text-base md:text-lg text-gray-700 mb-4 mt-3 leading-relaxed">
