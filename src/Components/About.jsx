...
const AnimatedContainer = ({ children }) => {
  ...
  return (
    <div
      ref={ref}
      className={`fade-in w-3/4 bg-white bg-opacity-30 backdrop-filter backdrop-blur-md container mx-auto px-4 flex flex-col md:flex-row items-center justify-center rounded-md ${inView ? 'visible' : ''}`}
    >
      {children}
    </div>
  );
...
const About = () => {
  return (
    <div id="About" className="container mx-auto mt-20 text-black grid grid-cols-2 gap-8">
      <AnimatedContainer>
        <div>
      ...
      <AnimatedContainer>
        <div>
          <h2 className="text-4xl font-extrabold mb-4 mt-4">Our Commitment to Quality</h2>
          <p className="text-lg text-gray-800 mb-6 mt-6 leading-relaxed">
      ...
      <AnimatedContainer>
        <div>
          <h2 className="text-4xl font-extrabold mb-4 mt-4">Unparalleled Selection</h2>
          <p className="text-lg text-gray-800 mb-6 mt-6 leading-relaxed">
      ...
      <AnimatedContainer>
        <div>
          <h2 className="text-4xl font-extrabold mb-4 mt-4">Expert Guidance</h2>
          <p className="text-lg text-gray-800 mb-6 mt-6 leading-relaxed">
