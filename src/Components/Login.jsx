...
return (
    ...
    <section className="bg-gray-200 h-screen flex flex-col md:flex-row justify-center space-y-10 md:space-y-0 md:space-x-16 items-center my-2 mx-5 md:mx-0 md:my-0">
      <div className="md:w-1/3 max-w-sm bg-white bg-opacity-30 backdrop-filter backdrop-blur-md p-8 rounded-md shadow-md text-center">
        <div className="text-center md:text-left">
          ...
          <button
            type="button"
            className="mx-1 h-9 w-9 rounded-full bg-sky-600 hover:bg-sky-700 text-white shadow-[0_4px_9px_-4px_#3b71ca]">
            <svg
          ...
          <button
            type="button"
            className="inlne-block mx-1 h-9 w-9 rounded-full bg-sky-600 hover:bg-sky-700 uppercase leading-normal text-white shadow-[0_4px_9px_-4px_#3b71ca]">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="mx-auto h-3.5 w-3.5"
              fill="currentColor"
